        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header text-right">
              <h4 class="title-page alert alert-primary text-center"> <i class="fas fa-info-circle"></i> Grades & Seating Numbers</h4>
              <a href="{{route('student-grades.create', $student_id)}}" class="btn btn-success">Add</a> 
          </div>
            <div class="card-body">
                        ...
                        <td class="settings">
                          <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  <a class="dropdown-item btn btn-success" href="{{route('student-grades.edit', ['student_grade' => $row->id, 'student_id' => $student_id])}}"><i class="fa fa-edit"></i> Edit</a>
                                ...
                                <div class="modal fade" id="myModal-{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                  ...
                                  <form role="form" action="{{route('student-grades.destroy', [$row->id, 'student_id' => $student_id])}}" method="POST">
